 ...
 * Includes refresh prices button with last-updated timestamp.
 */
(function () {
  var icons = {
  ...
  // Refresh button with timestamp inside
  ...
  updateTimestamp();
  // Expose globally so page scripts can trigger update after data loads
